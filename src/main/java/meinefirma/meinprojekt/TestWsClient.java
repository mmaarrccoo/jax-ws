...
import meinefirma.meinprojekt.ws.BuecherServiceIntf;
import meinefirma.meinprojekt.ws.BuecherTO;
			...
			while (service == null) {
				try {
					service = Service.create(
							new URL(url + "?wsdl"),
							new QName("http://ws.meinprojekt.meinefirma/", "BuecherServiceImplService"));
